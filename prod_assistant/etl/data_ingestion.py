...
class DataIngestion():
    ...
    def _load_csv(self): #Loading csv that we get after scrapping data
        """
    ...
    def transform_data(self):
        """
        Transform product data DataFrame into a list of LangChain Document objects.
        """
        documents = []

        # Loop directly over DataFrame rows
        for _, row in self.product_data.iterrows():
            # Prepare metadata dictionary from row
            metadata = {
            ...
            # Create a Document object with top_reviews as page_content
